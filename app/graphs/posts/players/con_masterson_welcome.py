...
print(root)
png_path1 = root / 'images' / 'con_masterson_welcome1.png'
json_path1 = root / 'app' / 'static' / 'jsons' / 'players' / 'CM' / 'con_masterson_welcome1.json'
png_path2 = root / 'images' / 'con_masterson_welcome2.png'
json_path2 = root / 'app' / 'static' / 'jsons' / 'players' / 'CM' / 'con_masterson_welcome2.json'
png_path3 = root / 'images' / 'con_masterson_welcome3.png'
json_path3 = root / 'app' / 'static' / 'jsons' / 'players' / 'CM' / 'con_masterson_welcome3.json'


data =[
    ["Player","Pass%","LongBall%","Duels%","Aerial_Duels%","Defensive Contributions","Recoveries","Interceptions","Tackles"],
    ["Conor Masterson",80.1,40.0,53.2,53.6,8.73,2.15,0.84,0.72],
    ["Omar Beckles",64.2,42.9,63.6,64.3,12.62,4.69,1.20,2.16],
    ["Benn Ward",66.2,25.4,62.3,68.2,13.11,5.07,2.05,1.53]
]
