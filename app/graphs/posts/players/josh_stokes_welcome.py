"""
    josh_stokes_welcome.py
"""
import altair as alt
import pandas as pd
from pathlib import Path
root = Path(__file__).resolve().parents[4]
png_path1 = root / 'images' / 'josh_stokes_welcome1.png'
json_path1 = root / 'app' / 'static' / 'jsons' / 'players' / 'JS' / 'josh_stokes_welcome1.json'
png_path2 = root / 'images' / 'josh_stokes_welcome2.png'
json_path2 = root / 'app' / 'static' / 'jsons' / 'players' / 'JS' / 'josh_stokes_welcome2.json'
png_path3 = root / 'images' / 'josh_stokes_welcome3.png'
json_path3 = root / 'app' / 'static' / 'jsons' / 'players' / 'JS' / 'josh_stokes_welcome3.json'

data =[
    ["Player","Pass%90","Longball%90","Dribble%90","G+A90","ExpG+A90"],
    ["Josh Stokes",71.6,47.2,47.4,0.39,0.54],
    ["Kamari Doyle",80.3,61.9,50.8,0.31,0.29],
    ["Reece Cole",70.8,43.1,57.1,0.50,0.28]
]
