...
data = [
    ...
    ["Reading",3.50,19,6,27,5,10,3,34,70,30,33],
    ["Blackpool",0.51,8,1,21,17,2,5,23,81,28,39]
]

png_path1 = root / 'images' / 'L1_blackpool_h_1.png'
json_path1 = root / 'app' / 'static' / 'jsons' / 'matches' / '2627' / 'Blackpool' / 'L1_blackpool_h_1.json'
png_path2 = root / 'images' / 'L1_blackpool_h_2.png'
json_path2 = root / 'app' / 'static' / 'jsons' / 'matches' / '2627' / 'Blackpool' / 'L1_blackpool_h_2.json'
png_path3 = root / 'images' / 'L1_blackpool_h_3.png'
json_path3 = root / 'app' / 'static' / 'jsons' / 'matches' / '2627' / 'Blackpool' / 'L1_blackpool_h_3.json'
