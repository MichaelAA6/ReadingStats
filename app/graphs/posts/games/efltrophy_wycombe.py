...
data = [
    ...
    ["Reading",15,6,21,12,8,5,25,78,28,17],
    ["Wycombe",13,5,27,13,4,4,32,85,56,40]
]
png_path1 = root / 'images' / 'efltrophy_wycombe1.png'
json_path1 = root / 'app' / 'static' / 'jsons' / 'matches' / '2627' / 'Wycombe' / 'efltrophy_wycombe1.json'
png_path2 = root / 'images' / 'efltrophy_wycombe2.png'
json_path2 = root / 'app' / 'static' / 'jsons' / 'matches' / '2627' / 'Wycombe' / 'efltrophy_wycombe2.json'
png_path3 = root / 'images' / 'efltrophy_wycombe3.png'
json_path3 = root / 'app' / 'static' / 'jsons' / 'matches' / '2627' / 'Wycombe' / 'efltrophy_wycombe3.json'
