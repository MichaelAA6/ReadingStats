...
data = [
    ...
    ["Reading",1.41,19,4,39,15,5,3,35,74,28,38],
    ["Cambridge",0.74,11,5,22,13,11,8,47,68,38,32]
]

png_path1 = root / 'images' / 'L1_cambridge_a_1.png'
json_path1 = root / 'app' / 'static' / 'jsons' / 'matches' / '2627' / 'Cambridge' / 'L1_cambridge_a_1.json'
png_path2 = root / 'images' / 'L1_cambridge_a_2.png'
json_path2 = root / 'app' / 'static' / 'jsons' / 'matches' / '2627' / 'Cambridge' / 'L1_cambridge_a_2.json'
png_path3 = root / 'images' / 'L1_cambridge_a_3.png'
json_path3 = root / 'app' / 'static' / 'jsons' / 'matches' / '2627' / 'Cambridge' / 'L1_cambridge_a_3.json'
