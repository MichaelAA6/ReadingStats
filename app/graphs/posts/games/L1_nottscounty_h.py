...
data = [
    ...
    ["Reading",2.62,17,7,25,12,17,4,27,79,45,26],
    ["Notts County",0.59,12,2,9,14,10,7,39,77,12,31]
]

png_path1 = root / 'images' / 'L1_nottscounty_h_1.png'
json_path1 = root / 'app' / 'static' / 'jsons' / 'matches' / '2627' / 'NottsCounty' / 'L1_nottscounty_h_1.json'
png_path2 = root / 'images' / 'L1_nottscounty_h_2.png'
json_path2 = root / 'app' / 'static' / 'jsons' / 'matches' / '2627' / 'NottsCounty' / 'L1_nottscounty_h_2.json'
png_path3 = root / 'images' / 'L1_nottscounty_h_3.png'
json_path3 = root / 'app' / 'static' / 'jsons' / 'matches' / '2627' / 'NottsCounty' / 'L1_nottscounty_h_3.json'
