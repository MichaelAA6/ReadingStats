...
data = [
    ...
    ["Reading",1.77,17,5,24,11,9,1,28,71,44,11],
    ["Luton",1.60,12,5,24,19,10,11,46,83,22,20]
]

png_path1 = root / 'images' / 'L1_luton_h_1.png'
json_path1 = root / 'app' / 'static' / 'jsons' / 'matches' / '2627' / 'Luton' / 'L1_luton_h_1.json'
png_path2 = root / 'images' / 'L1_luton_h_2.png'
json_path2 = root / 'app' / 'static' / 'jsons' / 'matches' / '2627' / 'Luton' / 'L1_luton_h_2.json'
png_path3 = root / 'images' / 'L1_luton_h_3.png'
json_path3 = root / 'app' / 'static' / 'jsons' / 'matches' / '2627' / 'Luton' / 'L1_luton_h_3.json'
