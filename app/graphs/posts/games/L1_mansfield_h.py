...
data = [
    ...
    ["Reading",2.68,20,7,28,11,9,2,28,77,31,11],
    ["Mansfield",1.38,11,5,20,15,12,6,37,76,40,38]
]

png_path1 = root / 'images' / 'L1_mansfield_h_1.png'
json_path1 = root / 'app' / 'static' / 'jsons' / 'matches' / '2627' / 'Mansfield' / 'L1_mansfield_h_1.json'
png_path2 = root / 'images' / 'L1_mansfield_h_2.png'
json_path2 = root / 'app' / 'static' / 'jsons' / 'matches' / '2627' / 'Mansfield' / 'L1_mansfield_h_2.json'
png_path3 = root / 'images' / 'L1_mansfield_h_3.png'
json_path3 = root / 'app' / 'static' / 'jsons' / 'matches' / '2627' / 'Mansfield' / 'L1_mansfield_h_3.json'
