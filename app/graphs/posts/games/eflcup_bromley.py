...
data = [
    ...
    ["Reading",2.40,16,5,36,11,4,6,43,78,37,33],
    ["Bromley",1.67,15,3,28,22,13,5,40,65,26,35]
]
png_path1 = root / 'images' / 'eflcup_bromley1.png'
json_path1 = root / 'app' / 'static' / 'jsons' / 'matches' / '2627' / 'eflcup_bromley1.json'
png_path2 = root / 'images' / 'eflcup_bromley2.png'
json_path2 = root / 'app' / 'static' / 'jsons' / 'matches' / '2627' / 'eflcup_bromley2.json'
png_path3 = root / 'images' / 'eflcup_bromley3.png'
json_path3 = root / 'app' / 'static' / 'jsons' / 'matches' / '2627' / 'eflcup_bromley3.json'
