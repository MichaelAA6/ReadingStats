...
data = [
    ...
    ["Reading",1.40,17,3,19,14,10,6,20,73,31,36],
    ["Brentford",3.21,24,8,32,10,7,6,31,91,53,32]
]

png_path1 = root / 'images' / 'eflcup_brentford1.png'
json_path1 = root / 'app' / 'static' / 'jsons' / 'matches' / '2627' / 'eflcup_brentford1.json'
png_path2 = root / 'images' / 'eflcup_brentford2.png'
json_path2 = root / 'app' / 'static' / 'jsons' / 'matches' / '2627' /'eflcup_brentford2.json'
png_path3 = root / 'images' / 'eflcup_brentford3.png'
json_path3 = root / 'app' / 'static' / 'jsons' / 'matches' / '2627' / 'eflcup_brentford3.json'
