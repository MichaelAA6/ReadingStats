...
def goalkeepers():
    apps_graph,card_graph,conceded_graph,save_graph = goalkeepers_graph()
    return render_template('goalkeepers.html',apps_graph=apps_graph,card_graph=card_graph,conceded_graph=conceded_graph,save_graph=save_graph)
